...
**_Git_** is defined as the _**system**_ that gives you the ability to _**save changes**_ made to your file _**over time**_ as _**previous versions**_ of the project, while having control over them. This is called _Version Control_.  
